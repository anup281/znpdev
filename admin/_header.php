...
?><?php znp_workspace_document_start('ZNP Admin', 'admin-body', '../assets/site.css', '20260723-598'); ?>
<header class="admin-top znp-workspace-top"><?php znp_render_workspace_brand('Admin', $investmentsOnly ? 'opportunities.php' : 'index.php', $investmentsOnly ? 'ZNP Investments' : 'ZNP Admin Dashboard', 'admin-brand'); ?><button class="admin-menu-toggle" type="button" aria-label="Open admin menu" aria-expanded="false" aria-controls="admin-nav"><span></span><span></span><span></span></button><nav id="admin-nav" aria-label="Admin navigation">
