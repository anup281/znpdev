...
<header class="management-top znp-workspace-top">
  ...
  <nav id="management-nav" class="znp-workspace-nav" aria-label="Management navigation">
    <a class="<?=manage_nav_active(['index.php'])?>" href="<?=manage_e(app_url('/manage/'))?>">Dashboard</a>
    ...
    <a class="<?=manage_nav_active(['users.php'])?>" href="<?=manage_e(app_url('/manage/users.php'))?>">Users</a>
