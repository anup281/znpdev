...
?><?php znp_workspace_document_start((string)$project['project_name'].' | ZNP Investors', 'investor-portal-page', '/assets/site.css', '20260722-522'); ?>
...
<script src="<?=e(app_url('/portal/assets/waterfall-calculator.js'))?>?v=20260722-522"></script>
