...
$projectPages=['project.php','calendar.php','buildings.php','schedule.php','tasks.php','documents.php','project_team.php','daily_logs.php','photo_recovery.php','photos.php','expenses.php'];
$projectsActive=in_array($current,array_merge(['projects.php'],$projectPages),true);
$projectTabMap=['project.php'=>'overview','calendar.php'=>'calendar','buildings.php'=>'buildings','schedule.php'=>'schedule','tasks.php'=>'tasks','documents.php'=>'documents','project_team.php'=>'team','daily_logs.php'=>'logs','photo_recovery.php'=>'logs','photos.php'=>'photos','expenses.php'=>'expenses'];
...
?><?php znp_workspace_document_start('ZNP Construction', '', 'assets/dev.css', '20260721-534'); ?>
<header class="dev-top dev-top-admin-style znp-workspace-top">
  <?php znp_render_workspace_brand('Construction', 'index.php', 'ZNP Construction Dashboard', 'dev-brand'); ?>
  <details class="dev-native-menu">
    ...
    <div class="dev-native-menu-panel">
      ...
      <?php if(dev_is_super()):?><a class="<?=$current==='users.php'?'active':''?>" href="users.php">Users</a><a class="<?=in_array($current,['companies.php','vendor_profile.php','trade_settings.php'],true)?'active':''?>" href="companies.php">Vendors</a><a class="<?=$current==='schedule_templates.php'?'active':''?>" href="schedule_templates.php">Schedule Templates</a><?php endif;?>
      <a href="../admin/index.php">Admin Portal</a><a href="../index.php">Public Website</a><a href="../logout.php">Sign Out</a>
    </div>
  </details>
...
<main class="dev-main">
<?php if($projectId && $current!=='projects.php'): $navProject=dev_project($projectId); if($navProject && dev_can_access($projectId)): ?>
<div class="project-context"><strong>CURRENT PROJECT: <?=e(strtoupper((string)$navProject['project_name']))?></strong></div>
...
<a class="<?=$activeProjectTab==='buildings'?'active':''?>" href="buildings.php?project_id=<?=$projectId?>">Buildings</a>
<a class="<?=$activeProjectTab==='schedule'?'active':''?>" href="schedule.php?project_id=<?=$projectId?>">Schedule</a>
...
<a class="<?=$activeProjectTab==='schedule'?'active':''?>" href="<?=e($projectUrl('schedule.php'))?>"><span aria-hidden="true">▤</span>Schedule</a>
