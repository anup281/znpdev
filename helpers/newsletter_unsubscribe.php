...
?><main><section class="public-page-hero"><div class="container"><h1>Email Preferences</h1><p><?=e($message)?></p></div></section><section class="container band"><a class="primary" href="<?=e(app_url('/'))?>">Return Home</a></section></main><?php include __DIR__.'/../includes/footer.php';?>
